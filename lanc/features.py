...
GEOMETRY_FEATURES = ["log_distance", "theta_v_deg", "rx_height_m"]
FREQUENCY_FEATURES = ["frequency_ghz"]
ANTENNA_FEATURES = ["delta_theta_h_sin", "delta_theta_h_cos", "antenna_pattern_id"]
BUILDING_FEATURES = [
    "rx_is_building",
...
def prepare_matrix_pack(
    ...
    return MatrixPack(train_parts, val_parts, test_parts, y_train, y_val, y_test, target_scaler, feature_scalers)
